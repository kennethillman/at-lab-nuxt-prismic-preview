export default {
  ...
  */
  head: {
    title: 'AT-LAB | Preview | Nuxt + Prismic ',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { hid: 'description', name: 'description', content: 'AT-LAB, Preview exampel for Nuxt + Prismic ' }
    ],
    link: [
  ...
  */
  ...
  prismic: {
    endpoint: 'https://at-lab-nuxt-prismic-preview.cdn.prismic.io/api/v2',
